...
public class BuddyController {
    ...
    public String home(Model model, @RequestParam(required = false) Long skill, Authentication authentication) {
        ...
        String email = authentication.getName(); // Get the email of the authenticated buddy
        Buddy buddy = buddyRepository.findByEmail(email).orElse(null); // Find the buddy by email
        model.addAttribute("buddies", buddies);
        model.addAttribute("skills", skills);
        model.addAttribute("buddy", buddy); // Add the buddy to the model
        return "home";
    }
    ...
    public String viewMessages(Model model, Authentication authentication) {
        String email = authentication.getName(); // Assuming the user's email is used as the username
